...
import { openLabelsDialog, selectLabels } from 'app/redux/notes/labelsSlice';
      ...
      >
        <List className="">
          ...
          >
            ...
            <ListItemText className="truncate" primary="Notas" disableTypography />
          </StyledListItem>
          <StyledListItem
            button
            component={NavLinkAdapter}
          ...
          >
            ...
            <ListItemText className="truncate" primary="Recordatorios" disableTypography />
          </StyledListItem>
          ...
          >
            ...
            <ListItemText className="truncate" primary="Archivo" disableTypography />
          </StyledListItem>
          ...
          <StyledListItem button onClick={(ev) => dispatch(openLabelsDialog())}>
            ...
            <ListItemText className="truncate" primary="Editar Etiquetas" disableTypography />
          </StyledListItem>
        </List>
      </div>
    </div>
