...
import { setSelectedItem, setSelectedButton } from 'app/redux/file-manager/itemsSlice';
...
function FileItem(props) {
  ...
  return (
    <Box
      ...
      onClick={() => { dispatch(setSelectedButton(null)), dispatch(setSelectedItem(item.id)) }}
    >
