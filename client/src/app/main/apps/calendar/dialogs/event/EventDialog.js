...
import { selectFirstLabelId } from 'app/redux/calendar/labelsSlice';
import { getEvents } from 'app/redux/calendar/eventsSlice';
...
function EventDialog(props) {
  ...
  function onSubmit(ev) {
    ...
    if (eventDialog.type === 'new') {
      ...
      dispatch(updateEvent({ ...eventDialog.data, ...data })).then(() => {
        dispatch(getEvents());
      });
    }
    closeComposeDialog();
  ...
  return (
    ...
    >
      <div className="flex flex-col max-w-full p-24 pt-32 sm:pt-40 sm:p-32 w-480">
        <div className="flex items-center flex-row-reverse w-full mb-24 -mt-24">
          <IconButton
            className=""
            size="large"
        ...
        <div className="flex sm:space-x-24 mb-16 -mt-8">
