...
import { closeLabelsDialog, selectLabels, selectLabelsDialogOpen } from 'app/redux/calendar/labelsSlice';
...
function LabelsDialog(props) {
  ...
  return (
    ...
    >
      <Typography className="text-20 mb-24 font-semibold">Editar Etiquetas</Typography>
